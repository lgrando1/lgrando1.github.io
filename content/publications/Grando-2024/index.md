...
publication: In *2024 Winter Simulation Conference*
...
tags: [Smart agriculture, Precision agriculture, Performance evaluation, Visualization, Disasters, Computational modeling, Batteries, Viruses (medical), Drones, Diseases]
...
links:
  - name: PDF (IEEE Xplore)
    url: 'https://ieeexplore.ieee.org/document/10839001'
    icon: hero/document-text
  
# Os campos abaixo foram removidos ou são redundantes com a nova estrutura de `links`:
# url_pdf: 'https://ieeexplore.ieee.org/document/10839001' # <--- REMOVIDO
