...
| [Canal do Telegram Data Science, Programação e Simulação](https://t.me/s/simulacao) |
| ----------- |
| 👉  Canal do Telegram com novidades sobre Machine Learning, Inteligência Artificial e Simulação | 
...
| [Save Money: Learn to Code From Home](https://couponfollow.com/research/learn-to-code-from-home) |
| ----------- |
| 👉  Uma sugestão de uma leitora do blog com bons recursos para aprender a programar. |

| [STEM Identity Resources for Women and Girls](https://collegeeducated.com/resources/stem-resources-for-women-girls/) |
| ----------- |
| 👉  Recursos do site College Educated para  [STEM](https://en.wikipedia.org/wiki/Science,_technology,_engineering,_and_mathematics) voltado para mulheres. |
...
| ----------- |
|  👉  Uma sugestão incrivel de uma leitora com uma lista de recursos para IA e ferramentas de programação |
